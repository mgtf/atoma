...
Thank you for your interest in contributing to atoma (the "Project"). This
Contributor License Agreement ("Agreement") clarifies the intellectual property
licence granted with Contributions from any person or entity. It protects you
as a contributor as well as the Project and its users; it does not change your
...
the copyright owner that is entering into this Agreement. For legal entities,
...
to the Project for inclusion in, or documentation of, the Project's software.
"Submit" means any form of communication sent to the Project or its
maintainers, including pull requests, patches, issues and comments, excluding
communication conspicuously marked "Not a Contribution".

"Licensor" means Matthieu Foillard, the copyright holder of the Project, and
any successor or assignee of the Project's copyright.

## 2. Grant of copyright licence

Subject to the terms of this Agreement, You hereby grant to the Licensor and to
...
and otherwise transfer the Project, where such licence applies only to those
...
- Each of Your Contributions is Your original creation. Where a Contribution
  ...
  together with its licence, in the Contribution itself.
...
between You and the Licensor concerning Contributions; if any provision is
found unenforceable, the remainder stays in force.

---

Signing is done once, on Your first pull request, through the CLA bot that
comments on it. Signing on behalf of an entity requires authority to bind it.
