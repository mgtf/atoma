...
```bash
npm install
npm run typecheck && npm test     # 1204 tests, no API key needed. Model calls are mocked,
...
**Working research system, honestly labelled.** ~25,000 lines of strict TypeScript, 1210 tests,
