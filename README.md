...
![tests](https://img.shields.io/badge/tests-1240_passing-brightgreen)
...
```bash
npm install
npm run typecheck && npm test     # 1234 tests, no API key needed. Model calls are mocked,
...
**Working research system, honestly labelled.** ~25,000 lines of strict TypeScript, 1240 tests,
