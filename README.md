...
file counts, `captured`/`skipped` lists) and prunes old snapshots (`--keep`,
default 14). None of that state is regenerable from the repository. Docker is optional for the core runner: `npm run build:worker` enables
