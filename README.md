...
![tests](https://img.shields.io/badge/tests-1208_passing-brightgreen)
...
```bash
npm install
npm run typecheck && npm test     # 1202 tests, no API key needed. Model calls are mocked,
...
**Working research system, honestly labelled.** ~25,000 lines of strict TypeScript, 1208 tests,
