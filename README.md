...
![tests](https://img.shields.io/badge/tests-1241_passing-brightgreen)
...
```bash
npm install
npm run typecheck && npm test     # 1235 tests, no API key needed. Model calls are mocked,
...
**Working research system, honestly labelled.** ~25,000 lines of strict TypeScript, 1241 tests,
