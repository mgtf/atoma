...
| **W12** | Platform terms | [Commons terms drafted with confirmed operator identity and contact](platform-commons-terms.md) | Publication | Terms of use covering what a run contributes to and consumes from the commons; separate from AGPL-3.0. |
