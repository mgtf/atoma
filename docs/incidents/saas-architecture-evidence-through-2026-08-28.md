> **ARCHIVE — NON-NORMATIVE.** This is the pre-reconciliation version of
> `docs/saas-architecture.md`, preserved on 2026-08-28 because it contains
> dated reproductions and migration analysis that the current architecture
> contract intentionally no longer carries inline. The normative document is
> [`docs/saas-architecture.md`](../saas-architecture.md). Read this file as
> historical evidence only; present-tense status claims below are frozen at
