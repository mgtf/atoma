<!-- agents-archive: engineering-record-2026-08-14 -->

# Frozen engineering record — through 2026-08-14

> Historical archive, not normative agent guidance. The active rules live in
> [`../../AGENTS.md`](../../AGENTS.md). This file preserves the complete
> incident narratives, measurements, rejected designs, and benchmark record
> that previously made the root guidance exceed 5,400 lines. Do not append
> current rules here; link new evidence from the concise root file instead.
