...
export const SMOKE_DESIGN_GUIDANCE = [
  ...
  `have about the page, in a single call:`,
  `    (() => ({`,
  ...
  `  1. COST — a returned OBJECT is truthy, so the check passes, and the`,
  `     whole object comes back to you in \`smokeResult\`. One page load`,
