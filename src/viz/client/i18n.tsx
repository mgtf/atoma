...
export const I18N_CATALOGS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'projects.actionsHint.ready': 'This prompt is for the next run on {{name}} only. Later runs can add features or fix what was produced.',
  ...
  fr: {
    ...
    'projects.actionsHint.ready': 'Ce prompt ne vaut que pour le prochain run sur {{name}}. Les suivants peuvent ajouter des features ou corriger ce qui a été produit.',
