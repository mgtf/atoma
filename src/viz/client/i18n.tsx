...
export const I18N_CATALOGS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'projects.actionsHint.ready': 'This prompt is for the next run on {{name}} only. Later runs build on what was produced — but only the FIRST delivered run publishes to GitHub today.',
    ...
    'announce.untranslated': 'No translation service is configured here. Write the other languages yourself.',
    'announce.send': 'Send',
  ...
  fr: {
    ...
    'projects.actionsHint.ready': 'Ce prompt ne vaut que pour le prochain run sur {{name}}. Les suivants repartent de ce qui a été produit — mais seul le PREMIER run livré publie sur GitHub aujourd’hui.',
    ...
    'announce.untranslated': 'Aucun service de traduction n’est configuré ici. Saisis les autres langues toi-même.',
